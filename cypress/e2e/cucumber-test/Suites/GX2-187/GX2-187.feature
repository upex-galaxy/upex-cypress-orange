Feature: US GX2-187 | TS: ✅OrangeHRM | PIM | Editar perfil de empleado
	...
	Scenario Outline: US GX2-187 | TS GX2-188 | TC1:  Verificar que editar la informacion personal del empleado funcione como se espera
		...
		When el admin inserta nuevos valores validos en los campos del form como "<firstName>","<MiddleName>","<lastName>","<NickName>","<EmployeeID>","<Nationality>","<DateOfBirth>","<Gender>"
		And hace click en el botón "Save"
		Then debe aparecer un Log Message indicando "<LogMessage>"
		...
		Examples:
			...
			| D                              | Del        | C                              | Milin                               | 1234567890 | 14          | 1980-06-10  | Female | "Success, Succesfully Saved" |
			| A                              | Mar        | Garciaaaaaaaaaaaaaaaaaaaaaaaaa | Garchi                              | 1          | 4           | 1982-06-11  | Female | "Success, Succesfully Saved" |
			| Rafaelllllllllllllllllllllllll |            | Mejias                         | Pichi                               | 1234567890 | 5           | 1982-06-11  | Male   | "Success, Succesfully Saved" |
			| Deniel                         | Dani       | 1234567                        | Cocoooooooooooooooooooooooooooooooo | 1          | 6           | 1982-06-11  | Male   | "Success, Succesfully Saved" |
