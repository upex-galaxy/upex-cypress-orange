Feature: US GX2-187 | TS: ✅OrangeHRM | PIM | Editar perfil de empleado
	...
	Scenario Outline: US GX2-187 | TS GX2-188 | TC1:  Verificar que editar la informacion personal del empleado funcione como se espera
		...
		Examples:
			...
			| D                              | Del        | C                              | Milin                               | 1234567890 | American  | 1980-06-10  | Female | "Success, Succesfully Saved" |
			| A                              | Mar        | Garciaaaaaaaaaaaaaaaaaaaaaaaaa | Garchi                              | 1          | American  | 1982-06-11  | Female | "Success, Succesfully Saved" |
			| Rafaelllllllllllllllllllllllll |            | Mejias                         | Pichi                               | 1234567890 | American  | 1982-06-11  | Male   | "Success, Succesfully Saved" |
			| Deniel                         | Dani       | 1234567                        | Cocoooooooooooooooooooooooooooooooo | 1          | American  | 1982-06-11  | Male   | "Success, Succesfully Saved" |
