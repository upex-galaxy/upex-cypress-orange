...
Feature: ✅OrangeHRM | PIM | Agregar un nuevo empleado con usuario
	...
	Scenario Outline: 252 | TC3: Intentar validar que administrador agregue campo invalido a employeeID
        ...
        ##Se comenta el caso de abajo por error de enhacement
	Scenario Outline: 252 | TC4: Intentar validar que administrador agregue campo invalido a username
		...
		Examples:
            ...
            ##| MaximilianoRodriguezzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz | Should not exceed 35 characters |

        ##Se comenta el ultimo caso de abajo por error de enhacement    
	Scenario Outline: 252 | TC5: Intentar validar que administrador agregue campo invalido a password
		...
		Examples:
			...
			##| PHRVgp8Ez&8*jNK9uy@FiC1V!4%sTFMeVVnSJ847eHXFv0vCI4bcc9WirariI36mdoAf0H0%l3 | Should not exceed 74 characters                                                                                                 |
    ...
    Scenario Outline: 252 | TC6: Intentar validar que administrador agregue campo invalido a confirmPassword
		...
		Examples:
            ...
            ##| PHRVgp8Ez&8*jNK9uy@FiC1V!4%sTFMeVVnSJ847eHXFv0vCI4bcc9WirariI36mdoAf0H0%l3 | PHRVgp8Ez&8*jNK9uy@FiC1V!4%sTFMeVVnSJ847eHXFv0vCI4bcc9WirariI36mdoAf0H0%l3 | Should not exceed 74 characters |