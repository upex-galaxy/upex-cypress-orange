class Employee{
    get = {
        ...
        EmployeeId: ()=> cy.xpath('//*[@id="app"]/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div[1]/div[1]/div/div[2]/input'),
...
clickSavePersonalDetails(){
    ...
    clickEmployeeProfileImage(){
        this.get.EmployeeProfileImage().click()
    }
...
/*
    SelectNewEmployeeChangeImageButton(){
        this.get.EmployeeChangeImageButton().
    }
*/
